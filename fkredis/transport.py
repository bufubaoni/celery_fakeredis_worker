...
from fkredis.client import FkRedisClient
from kombu.transport.redis import QoS
from kombu.five import Empty, string_t, values
from kombu.transport.redis import register_after_fork, promise, bytes_to_str, loads,\
    dumps, warn, bisect, numbers, InconsistencyError, READ, ERR, poll
...
class Channel(virtual.Channel):
    ...
    def get_table(self, exchange):
        ...
        with self.conn_or_acquire() as client:
            ...
            if not values:
                raise InconsistencyError("not value")
...
class Transport(virtual.Transport):
    ...
    def __init__(self, *arg, **kwargs):
        super(Transport, self).__init__(*arg, **kwargs)
